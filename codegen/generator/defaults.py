...
TYPE_MAPPING = {
    ...
    "receivingpit": {
        "tia_type": "TYPE_RECEIVING_PIT",
        "udt": "UDT_ReceivingPit",
        "array_name": "ReceivingPit",
        "count_const": "RECEIVING_PITS_COUNT",
        "has_simulator": False,
        "sim_state_udt": "",
        "sim_config_udt": "",
    },
    "separator": {
        "tia_type": "TYPE_SEPARATOR",
        "udt": "UDT_Separator",
        "array_name": "Separator",
        "count_const": "SEPARATORS_COUNT",
        "has_simulator": False,
        "sim_state_udt": "",
        "sim_config_udt": "",
    },
    "valve3p": {
        "tia_type": "TYPE_VALVE3P",
        "udt": "UDT_Valve3P",
        "array_name": "Valve3P",
        "count_const": "VALVES3P_COUNT",
        "has_simulator": False,
        "sim_state_udt": "",
        "sim_config_udt": "",
    },
    "silos": {
        ...
        "udt": "UDT_Silos",
        "array_name": "Silos",
        "count_const": "SILOS_COUNT",
        "has_simulator": False,
        "sim_state_udt": "",
        "sim_config_udt": "",
    },
    "sushka": {
        "tia_type": "TYPE_SUSHKA",
        "udt": "UDT_Sushka",
        "array_name": "Sushka",
        "count_const": "SUSHKAS_COUNT",
        "has_simulator": False,
        "sim_state_udt": "",
        "sim_config_udt": "",
    },
